...
const DraggableBox = ( { labelInfo, index, x_position, y_position, type, seats, setPositionMap, layoutID, positionMap, tableNumber, setCurrentFocusedComponent, currentFocusedComponent }) => {
  ...
  return (
      ...
      >
              <div>
                  <InnerDraggableBox setCurrentFocusedComponent={setCurrentFocusedComponent} index={index} labelInfo={labelInfo} layoutID={layoutID} currentFocusedComponent={currentFocusedComponent} type={type} />
